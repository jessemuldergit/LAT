...
$listBox.Height = 240
$listBox.Width  = 300
[void] $listBox.Items.Add('-------- Leen Attent--------')
[void] $listBox.Items.Add('leen-wk-1')
[void] $listBox.Items.Add('leen-wk-2')
[void] $listBox.Items.Add('leen-wk-3')
[void] $listBox.Items.Add('leen-wk-4')
