...
iex (irm https://raw.githubusercontent.com/jessemuldergit/LAT/refs/heads/main/LAT-ap-menu.ps1)

Write-Host -Foreground Red $GroupTag
sleep -Seconds 3

iex (irm https://raw.githubusercontent.com/jessemuldergit/LAT/refs/heads/main/LAT-functions.ps1)
...
if($GroupTag -eq 'leen-wk-2'){Dism /image:C:\ /Set-InputLocale:0413:00020409}
if($GroupTag -eq 'leen-wk-3'){Dism /image:C:\ /Set-InputLocale:0413:00020409}
if($GroupTag -eq 'leen-wk-4'){Dism /image:C:\ /Set-InputLocale:0413:00020409}
